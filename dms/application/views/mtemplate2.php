          ...
          <nav class="navbar navbar-inverse navbar-submenu">
            <div class="container-fluid">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('/admin/pengolah'); ?>">Data Tingkat Akses</a>
              </div>
              ...
              <?php
                  if(isset($peng)){
                      ...
                      foreach($peng as $u) {
                          ...
                          echo "<td>".$no."</td>";
                          echo "<td>".$u['akses']."</td>";
                          echo "<td><a onClick=\"setiduser(this.id)\" data-toggle=\"modal\" data-target=\"#editpeng\" class='edpeng' href='#' id='".$u['id']."' title=\"Edit\"><i class=\"glyphicon glyphicon-edit\"></i> </a></td>";
                          echo "<td><a onClick=\"setiduser(this.id)\" data-toggle=\"modal\" data-target=\"#delpeng\" class='delpeng' href='#' id='".$u['id']."' title=\"Delete\"><i class=\"glyphicon glyphicon-trash\"></i> </a></td>";
                          echo "</tr>";
                          $no++;
                      }
                  }
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
    	  ...
    	  <div class="modal-body">
    		<form id="faddpeng" class="form-horizontal" role="form" method="post" action="<?php echo site_url("/admin/addtaskes"); ?>">
    ...
    <div class="modal fade" id="editpeng">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
    	  ...
    	  <div class="modal-body">
    		<form id="fedpeng" class="form-horizontal" role="form" method="post" action="<?php echo site_url("/admin/edittaskes"); ?>">
    ...
    <div class="modal fade" id="delpeng">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
    	  ...
    	  <div class="modal-body">
    		<form id="fdelpeng" class="form-horizontal" role="form" method="post" action="<?php echo site_url("/admin/deltaskes"); ?>">
    	  ...
    	  <div class="modal-footer">
    		<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" id="delpenggo">Hapus</button>
    	  </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<script type="text/javascript">
  ...
  function fedpeng() {
    document.getElementById("fedpeng").submit();
  }
  function fdelpeng() {
  ...
  $("#divtabelpeng").on("click", ".edpeng", function() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo site_url("/admin/takses"); ?>",
      data: "id=" + d,
      cache: false,
