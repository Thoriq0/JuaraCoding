...
<div class="row" >
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" data-toggle="validator" action="<?php echo site_url('/admin/add_internal_dokumen'); ?>" method="post" enctype="multipart/form-data">
		        ...
		        <label class="col-sm-4 "> Group Dokumen</label>
				        <div class="col-sm-6">
							...
							<?php
                                    if(isset($kode)){
                                        foreach($kode as $k) {
                                            echo "<option value='".$k['nama']."-".$k['kode']."' >".$k['nama']." - ".$k['kode']."</option>";
                                        }
                                    }
                            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <input id="no_dok" name="no_dok" class="form-control input-md" type="text" required >
                </div>
            </div>
			
			<div class="form-group">
                <label class="col-md-4" for="nama_dok">Nama Dokumen</label>
                <div class="col-md-6">
                <input id="nama_dok" name="nama_dok" class="form-control input-md" type="text" required >
                </div>
            </div>

			<div class="form-group">
                <label class="col-md-4 " for="deskripsi">Deskripsi Dokumen</label>
                <div class="col-md-6">
			...
			<div class="form-group">
                <label class="col-md-4" for="owner">Owner Dokumen</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
					<div class="input-group">
						<input id="tgl_dok" name="tgl_dok" class="form-control input-md" type="text" required>
						<div class="input-group-addon">
                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                        </div>
					</div>
             ...
             <!-- <div class="form-group row">
		        <label class="col-sm-4 "> Tingkat Akses :</label>
				        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                if(isset($departemen)){
                                    foreach($departemen as $dp) {?>
                                        ...
                                        <h5><input class='<?= $dp['id']?>' type='checkbox' onClick="checkAll(this)" name='departemen[]' value='<?= $dp['nama_departemen']?>'> <?= $dp['nama_departemen'] ?> </h5>
                                        </header>
                                        <div class="panel-body">
                                        <?php foreach($tingkat as $u){
                                            if($dp['nama_departemen']==$u['departemen']){?>
                                                <input class="children<?=$dp['id']?>" type="checkbox" onClick="checkparent(this,'<?= $dp['id']?>')" name="du[]" value="<?=$dp['id']."-".$dp['nama_departemen']."-"?><?=$u['id']."-".$u['akses']?>">  <?= $u['akses'] ?><br>
                                        <?php    }
                                        }?>
                                        </div>
                                        </section>
