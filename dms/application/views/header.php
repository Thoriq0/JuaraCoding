...
?></title>
    ...
    <!-- Bootstrap Core CSS -->
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/flatly.bootstrap.min.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/heroic-features.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/jquery-ui.min.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/jquery-ui.structure.min.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/jquery-ui.theme.min.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/chosen.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/jquery.auto-complete.css') ?>" />
	<link type="text/css" rel="stylesheet" href="<?php echo base_url('/public/bootstrap/css/custom.css') ?>" />
	<script>
