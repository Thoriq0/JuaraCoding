...
<section class="content">
    <div class="row">
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
                        ...
                        <!-- <form class="navbar-form navbar-left width-half-full" method="get" action="<?php echo site_url('/admin/list_perizinan'); ?>"> -->
                        <div class="col-xs-3">
                            <table>
                                <tr> 
                                ...
                                <tr>
                                    <td style="color:white; width: 100%;">Nomor Perizinan &nbsp;</td><td><input type="text" id="nodokizin" name="nodokizin"  placeholder="" /></td>
                                </tr>
                                <tr>
                                    <td style="color:white; width: 100%;">Nama Perizinan &nbsp;</td><td><input type="text" id="nama" name="nama"  placeholder="" /></td>
                                </tr>
                                <!-- <tr>
                ...
                <!-- <form class="navbar-form navbar-left width-half-full" method="get" action="<?php echo site_url('/admin/list_perizinan'); ?>" id="srcmain">
                    <div class="input-group width-full">
                    <input type="text" name="katakunci" class="form-control" placeholder="" /><span class="input-group-btn">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
            ...
            <?php echo $this->session->flashdata('zz'); ?>
                <!-- <div class="panel panel-default panel-hidden collapse" id="advanced-search">
                    ...
                    <form action="<?php echo site_url('/admin/list_perizinan'); ?>" method="get" id="srcmain">
            ...
            <div class="well well-sm">
              <div class="row">
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='admin/input_perizinan';">Input Data</button> &nbsp;&nbsp;
                    <button class="btn btn-primary" type="button" onClick="sendemail()">Send Selected Email</button>
                    </br></br>
                    
                <form method="post" action="#" id="form">
                    <table width="100%" id="vizindoc" class="table table-bordered table-striped">
                        <thead>
                            <tr>    
                                    <th>
                        ...
                        foreach($data as $a) {
                            ...
                            *
                            ...
                            echo "<td><a href='".site_url('admin/viewIzin/'.$a['id'])."' ><span class='btn btn-xs btn-primary'><i class='fa fa-md fa-search' ></i> View</span></a>
                                &nbsp
                                <a href='".site_url('/admin/veditIzin/'.$a['id'])."'><span class='btn btn-xs btn-warning'><i class='fa fa-md fa-pencil' ></i> Edit</span></a>
                                </td>";
                            echo "</tr>";
                            $no++;
                        }*/
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $("#vizindoc").DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?php echo site_url('admin/get_list_perizinan') ?>",
                type: 'POST',
                data: function(data) {
                    data.nodokizin = $('#nodokizin').val();
                    data.nama = $('#nama').val();
            ...
            initComplete: function(data) {
                ...
                /*var input = $('#vizindoc_input').unbind(),
                    self = this.api(),
                ...
                $('#vizindoc_filter').append(searchButton);*/
            }
