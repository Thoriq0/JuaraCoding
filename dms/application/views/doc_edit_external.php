...
<div class="col-md-6"> <!-- 1st column -->
	...
	<div class="form-group">
		...
		<div class="col-md-6">
	   		<input id="nodok" name="nodok" class="form-control input-md" type="text" value="<?php echo $no_dokumen ?>" disabled>
		</div>
	</div>

	<div class="form-group ">
		<label class="col-md-4 " for="namaijin"> Nama Dokumen : </label>
		<div class="col-md-6">
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6">
           <input id="namaklien" name="namaklien" class="form-control input-md" type="text" value="<?php echo $nama_klien; ?>" required>
        </div>
    </div>
                        ...
                        foreach($departemen as $dp) {?>
                            ...
                            <?php foreach($user as $u){
                                if($dp['id']/*$dp->Division*/==$u['departemen']){?>
                                    <input class="children<?=$dp['id']/*$dp->Division*/?>" type="checkbox" onClick="checkparent(this,'<?= $dp['id']/*$dp->Division*/?>')" name="du[]" value="<?=$u['departemen']."-"?><?=$u['nik']?>" <?php foreach($akses_eksternal as $ae){echo ($ae['departemen'].'-'.$ae['user']==$dp['id']/*$dp->Division*/.'-'.$u['nik'])?" checked ":"";}
                        	?>>  <?= $u['nama'] ?><br>
                            <?php    }
                            }?>
                            </div>
