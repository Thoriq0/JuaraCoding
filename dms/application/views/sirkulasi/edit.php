  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
				...
				<nav class="navbar navbar-inverse navbar-submenu">
				  <div class="container-fluid">
				    ...
				    <div class="navbar-header">
				      ...
				      <a class="navbar-brand" href="<?php echo site_url('/sirkulasi/'); ?>">Data Sirkulasi</a>
				    </div>  
				...
				<!-- Form Name -->
				<div class="container">
				<div class="col-md-10"> <!-- 1st column -->
				...
				<div class="form-group col-md-10">
				  <button id="singlebutton" name="singlebutton" type="submit" class="pull-right btn btn-success"><i class="glyphicon glyphicon-save"></i> Simpan</button>
				</div>
