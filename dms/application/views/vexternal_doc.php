                    ...
                    <table border="0"> 
						...
						<tr>
                            ...
                            <td>
                                ...
                                //$encId = encrypt_url($doc['file']);
                                 ?>
								<!-- <?php echo ($doc['file']==""?"":"<a href='".base_url('uploads/'.$doc['file'])."' target='_blank'>".$doc['file']."</a>"); ?> -->
								<!--<?php echo ($doc['file']==""?"":"<a href='".base_url('file/'.$encId)."' target='_blank'>".$doc['file']."</a>"); ?>-->
								<?php echo ($doc['file']==""?"":"<a href='".base_url('admin/preview/'.$doc['file'])."' target='_blank'><span class='btn btn-xs btn-primary'><i class='fa fa-md fa-search' ></i> View</span></a>"); ?>
