...
<div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" data-toggle="validator" action="<?php echo site_url('/admin/add_perizinan'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <input id="noijin" name="noijin" class="form-control input-md" type="text" required >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <input id="namaijin" name="namaijin" class="form-control input-md" type="text" required >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <input id="reminder" name="reminder" class="form-control input-md" type="text">
                </div>
            </div>
            -->
            <div class="form-group">
            ...
            <!--
            <div class="form-group">
                <label class="col-md-4 " for="ket">Keterangan Keaslian :</label>
                <div class="col-md-6">
